...
class EnergyBudgetSensor(SensorEntity):
    ...
    def __init__(self, manager, name, days_for_profile):
        ...
        self._state = 0.0
        self._attrs = {}
        self.entity_id = f"{DOMAIN}.ems_surplus"
...
class MarketStrategySensor(SensorEntity):
    ...
    def extra_state_attributes(self):
        ...
        attrs = {
            ...
            "Power": res.get("recommended_power_kw", 0.0),
            "Charge amps": res.get("recommended_amps", 0.0),
...
class PotentialExportTodaySensor(SensorEntity):
    ...
    def __init__(self, manager):
        ...
        self.entity_id = f"{DOMAIN}.ems_potential_export"
